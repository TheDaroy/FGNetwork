...
void AFGPlayer::Tick(float DeltaTime)
{
	...
	{
		InterpLocationAndRotation(DeltaTime);	
	}
	else
	{
...
void AFGPlayer::InterpLocationAndRotation(float DeltaTime)
{
	SetActorLocation(FMath::VInterpTo(GetActorLocation(), TargetLocation, DeltaTime, MovementVelocity));
	SetActorRotation(FMath::RInterpTo(GetActorRotation(), TargetRotation, DeltaTime, MovementVelocity));
	
}

void AFGPlayer::CalculateAvrageSpeed()
{
